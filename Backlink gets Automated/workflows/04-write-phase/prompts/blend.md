...
10. PARAGRAPHS THAT RUN LONG. The counter listed these too. Over four sentences usually means two
    ...
    AND WATCH WHAT FAULT 9 DOES TO THIS ONE. Splitting a long sentence in two adds a sentence to its
    paragraph, so a paragraph already at four becomes five. If a split pushes a paragraph over four,
    split the paragraph as well. The two fixes go together or the second undoes the first.
