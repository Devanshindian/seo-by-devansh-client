You are deciding what to type into three search boxes to find what real practitioners say about this
article's subject.
...
════════════════════════════════════════════════════════════════════════
THE THREE PLACES, AND WHAT EACH ONE WILL TAKE FROM YOU
...
**All three sources get used.** Skipping one is not on the table here. If a source seems like a poor fit
for this article, give it your best one or two queries anyway and let the next step judge the results.
Deciding in advance that a place has nothing is exactly the guess this step exists to stop.
...
{"reddit": {"queries": [{"q": "<3-6 words>",
 ...
 "blind": {"queries": [{"q": "<3-6 words>", "serves": "...", "why": "..."}]},
 "linkedin": {"queries": [{"q": "<3-6 words>", "serves": "...", "why": "..."}]}}

Four to six Reddit queries. Two or three each for Blind and LinkedIn.
