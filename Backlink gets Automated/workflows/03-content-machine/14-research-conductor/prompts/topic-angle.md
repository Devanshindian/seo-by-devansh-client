...
An angle was written for it months ago, before anyone had seen this search. **Your job is to replace
...
Look at the gaps above and write what OUR READER GETS from our article.

Two lines is all you get, so cover as much of the gap list as two lines honestly can. Group the gaps
that belong together rather than listing them, and lead with the one that matters most.
